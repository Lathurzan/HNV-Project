  ...
  return (
    <footer className="bg-[#191919] text-white py-12 text-sm">
      ...
      <div className="text-center text-gray-500 text-xs mt-8">
        ...
        <span> <Link to="https://hnv-project-frontend.onrender.com/rights" className="hover:text-yellow-500 transition" onClick={scrollToTop}>All rights reserved.</Link></span>
      </div>
    </footer>
  );
};
